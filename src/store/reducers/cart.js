...
export function addProduct(product, products) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/cart-add', { product, products });
...
export function removeProduct(id, products) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/cart-remove', { id, products });
...
export function updateProduct(id, quantity, products) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/cart-update', { id, quantity, products });
...
export function setBillingAddress(address) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/billing-address', { address });
...
export function setDiscount(code, total) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/discount', { code, total });
...
export function setShippingCharge(charge, shipping) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/shipping-charge', { charge, shipping });
...
export function setPaymentMethod(method) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/payment-method', { method });
...
export function setPaymentCard(card) {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/card-payment', { card });
...
export function resetCart() {
  return async () => {
    try {
      const response = await axios.post('/api/e-commerce/cart-reset');
