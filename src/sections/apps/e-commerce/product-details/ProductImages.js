...
const prod1 = '/assets/images/e-commerce/prod-11.png';
const prod2 = '/assets/images/e-commerce/prod-22.png';
const prod3 = '/assets/images/e-commerce/prod-33.png';
const prod4 = '/assets/images/e-commerce/prod-44.png';
const prod5 = '/assets/images/e-commerce/prod-55.png';
const prod6 = '/assets/images/e-commerce/prod-66.png';
const prod7 = '/assets/images/e-commerce/prod-77.png';
const prod8 = '/assets/images/e-commerce/prod-88.png';
...
const ProductImages = () => {
  ...
  const initialImage = product?.image ? `/assets/images/e-commerce/${product.image}` : '';
